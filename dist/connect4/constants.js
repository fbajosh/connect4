...
export function topMaskCol(col) {
    return 1n << BigInt(HEIGHT - 1 + col * (HEIGHT + 1));
}
export function bottomMaskCol(col) {
    return 1n << BigInt(col * (HEIGHT + 1));
}
export function columnMask(col) {
